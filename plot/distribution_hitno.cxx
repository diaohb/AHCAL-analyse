...
int distribution_hitno() {
    ...
    //                        "/home/diaohb/CEPC/AHCAL-simulation/run/0826_30080126_trigger40_pi_126/list_PS_noise1/truth_analyse.root",
    ...
    TString filename[3] = {"/home/diaohb/CEPC/ihep/PS/analyse/intercept/e-list_analyse.root",
                           "/home/diaohb/CEPC/AHCAL-simulation/run/0824_30080126_trigger40/list_PS_noise1/calib_analyse.root",
                           "/home/diaohb/CEPC/AHCAL-simulation/run/0824_30080126_trigger40/list_PS_noise1/truth_analyse.root"};
    ...
    for (int i = 0; i < 3; i++) {
        ...
        tin->SetBranchAddress("track_chi2x", &track_chi2x);
        tin->SetBranchAddress("track_chi2y", &track_chi2y);
        ...
        double _e_hit = 0;
        int _cherenkov = 0;
        double _track_chi2x = 0;
        double _track_chi2y = 0;
        ...
        tin->SetBranchAddress("track_chi2x", &_track_chi2x);
        tin->SetBranchAddress("track_chi2y", &_track_chi2y);
        for (int n_entries = 0; n_entries < tin->GetEntries(); n_entries++) {
            ...
            for (int n_e = 0; n_e < n_total; n_e++) {
                ...
                if (_beam_energy == energy[n_e] && _select_flag == 6 && _rms < rms_limit[n_e]) {
                    ...
                    //     if (_layer->at(i) >= shower_layer[n_e] && _layer->at(i) < shower_layer[n_e] + 1 && _layer_hit_x->at(i) != -500 && _layer_hit_y->at(i) != -500 && (abs(_layer_hit_x->at(i) + 20) > 15 || abs(_layer_hit_y->at(i) - 20) > 15)) {
                    //         a = 1;
                    //         break;
                    //     }
                    // }
